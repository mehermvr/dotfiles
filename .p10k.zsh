# Generated by Powerlevel10k configuration wizard on 2023-04-18 at 18:24 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 06405.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean_8colors,
# 12h time, 2 lines, dotted, no frame, green-ornaments, compact, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=2
