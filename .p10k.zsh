# Generated by Powerlevel10k configuration wizard on 2023-07-30 at 16:12 CEST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 22109.
# Wizard options: nerdfont-v3 + powerline, small icons, unicode, lean_8colors, 12h time,
# 2 lines, dotted, no frame, blue-ornaments, sparse, many icons, fluent,
